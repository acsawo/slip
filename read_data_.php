...
{	//add tbmain
	...
	VALUES('$prename3', '$name4', '$lname5', '$bookbank13	', '$id_person2',  '', '', '$id_person2', $nobank9, '0')";
...
//ad tbdetail
/* $sql_add= "INSERT INTO tbdetail(nauto,yy,mm,idno,nobank,money1,money2,money3,money4,money5,
money6,money7,money8,money9,money10,sumget,exp1,exp2,exp3,exp4,exp5,exp6
,exp7,exp8,exp9,exp10,sumpay,sumnet,daypay,chk) 
VALUES('',{$data_line[$x][0]},{$data_line[$x][1]},{$data_line[$x][2]},{$data_line[$x][13]},{$money1},{$money2},{$money3},{$money4},{$money5},
{$money6},{$money7},{$money8},{$money9},{$money10},{$sumget},{$exp1},{$exp2},{$exp3},{$exp4},{$exp5},{$exp6},
{$exp7},{$exp8},{$exp9},{$exp10},{$sumpay},{$sumnet},'{$daypay}','{chk}')";  


mysqli_query($connect,$sql_add) or die ("Err Can not to ".mysqli_error($connect));
//echo $sql_add."<br><br>";
}
$num=$num-1;
