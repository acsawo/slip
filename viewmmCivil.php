...
<center><INPUT onclick="window.open('viewmmpdfCivil.php?vrec=<?php echo $vrec; ?>','_blank');"  value="พิมพ์ใบแจ้งเงินเดือน (PDF) ด้วย IE และ Chrome" type=button> <font face = "ms sans serif" size = "3" color="#FF0000"><b>||</b></font> <INPUT onclick="window.location='allmonth.php';" value="กลับหน้าแรก" type=button> <font face = "ms sans serif" size = "3" color="#FF0000"><b>||</b></font> <INPUT onclick="window.location='logout.php';" value="ออกจากระบบ" type=button></center><br>
<div id=divprint>
...
<tr><td width="100" align="center"><img src="images/logolerdsin.png" border="0" width="80"></td>
<td align="left"><font face = "ms sans serif" size = "5"><b>โรงพยาบาลเลิดสิน<br>ใบรับรองการจ่ายเงินเดือนและเงินอื่น</b></font></td>
<td align="right">&nbsp;</td>
</tr>
</table><br>
<table cellspacing="0" cellpadding="0" width="90%" border="0">
...
<td width="4%">&nbsp;</td>
<td width="43%" colspan="3" align="left"><font face = "ms sans serif" size = "3">โอนเงินเข้าวันที่ : <?php echo DateThai($rs['daypay']); ?></font></td></tr>
...
<br><dd>3.หากต้องการฉบับจริงหรือพบข้อมูลไม่ถูกต้อง กรุณาติดต่องานการเงิน ชั้น 9 อาคาร 33 ปี โทร 02-353 9763</font>
...
<br><dd>7. ต.ด.ข.1-7 คือ เงินค่าตอบแทนรายเดือนสำหรับข้าราชการระดับ 1-7 หรือเทียบเท่า ตามระเบียบฯ ข้อ 7 และข้อ 8
<br><dd>8. เงิน พ.ส.ร. คือ เงินเพิ่มพิเศษสำหรับการสู้รบ
<br><dd>9. พ.ต.ก. คือ เงินเพิ่มสำหรับตำแหน่งที่มีเหตุพิเศษ (นิติการ)
</td></tr>
</table>
